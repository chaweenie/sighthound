...
const PROJECTS = [
  {
    ...
    type: 'commercial',
    scope: 'renovation',
    description: "Sourced matching panels and finished them to blend seamlessly with existing millwork — a small job where getting the finish exactly right was the whole challenge.",
  ...
  },
  {
    ...
    type: 'apartment',
    scope: 'renovation',
    description: "A downtown apartment refresh: old carpeting replaced with modern flooring and walls repainted, plus general repairs and handyman work completed alongside.",
    folder: 'images/projects/2026/Beatty',
    images: ['IMG_1039.jpeg', 'IMG_1041.jpeg'],
  },
  {
    id: 'mcmyn',
    title: 'Apartment Flooring Renovation',
    year: 2026,
    type: 'apartment',
    scope: 'renovation',
    description: "Removed the existing flooring and installed new vinyl flooring throughout.",
  ...
  },
  {
    ...
    type: 'commercial',
    scope: 'renovation',
    description: "Built and installed custom cabinetry, wooden countertops, and millwork, and mounted signage, to complete this commercial space.",
  ...
  },
  {
    ...
    type: 'home',
    scope: 'renovation',
    description: "Converted an old shed into a cozy, comfortable loft space.",
  ...
  },
  {
    ...
    type: 'apartment',
    scope: 'renovation',
    description: "Custom laundry closet shelving for better organization, fresh paint in the bedroom and future nursery, and added shelving to make use of dead space in the bathroom.",
  ...
  },
  {
    ...
    type: 'home',
    scope: 'renovation',
    description: "Replaced the existing door and enlarged the entrance opening.",
